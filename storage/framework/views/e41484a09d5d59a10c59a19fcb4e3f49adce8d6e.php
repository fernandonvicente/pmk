...
<?php $__env->startSection('content-header'); ?>
  <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo e(url('pmkadmin/user/index')); ?>">Usuários</a></li>
        <?php endif; ?>
  ...
  <?php endif; ?>
      ...
      <div class="box box-default">
        ...
        <?php if($formAction=='create'): ?>
         <form action="<?php echo e(url('pmkadmin/user/store')); ?>" method="post" id="form_submit" name="form_submit" autocomplete="off" enctype="multipart/form-data">
        <?php else: ?>
          <form action="<?php echo e(url('pmkadmin/user/update')); ?>/<?php echo e($id); ?>" method="put" id="form_submit" name="form_submit" autocomplete="off" enctype="multipart/form-data">
        <?php endif; ?>
...
function excluirImagem(e){
  if (confirm("Tem certeza que deseja excluir a imagem?")) {
    ...
    $.post('<?php echo e(url("assets/funcoes/uploadGerenciamento.php")); ?>', {
      ...
      $.get('<?php echo e(url("/pmkadmin/user/updateAvatar/")); ?>/' + id, function (resposta) {
        // alert(resposta);
      });
      //
    });
...
<?php echo $__env->make('admin.layout.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projeto-base2\pmk\codigo\resources\views/admin/user/create-edit.blade.php ENDPATH**/ ?>