...
<head>
  ...
  <title><?php echo $__env->yieldContent('title', 'Gerenciamento do Controle Interno'); ?></title>
  ...
  <link rel="apple-touch-icon" href="<?php echo e(url('/assets/icones/favicon.ico')); ?>">
  <link rel="icon" type="image/png" href="<?php echo e(url('/assets/icones/favicon.ico')); ?>">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo e(route('admin::home')); ?>" class="logo">
      ...
      <span class="logo-lg"><b>Controle Interno</b></span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo e(url('/controleinternoadmin/user/edit')); ?>/<?php echo e(Auth::user()->id); ?>" class="btn btn-default btn-flat">Perfil</a>
                </div>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2021-<?php echo date('Y');?> <a href="<?php echo e(url('/controleinternoadmin')); ?>">Gerenciamento do Controle Interno</a>.</strong> Todos os direitos reservados.
  </footer>
...
</html><?php /**PATH C:\xampp7\htdocs\nara-sistema\nara-controleinterno\resources\views/admin/layout/template.blade.php ENDPATH**/ ?>