            ...
            <div class="box-header">
              <h3 class="box-title">  
                <div class="col-xs-12">  
                  ...
                  <a href="<?php echo e(url('pmkadmin/user/create')); ?>">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="<?php echo e(url('pmkadmin/user/edit')); ?>/<?php echo e($user->id); ?>"><i class="fa fa-fw fa-edit" title="Editar"></i></a>
                    <?php endif; ?>
...
<script>
  ...
  function excluirRegistro(idRegistro){
    if (confirm("Tem certeza que deseja excluir o registro?")) {
      ...
      $.get('<?php echo e(url("/pmkadmin/user/delete/")); ?>/' + id, function (resposta) {
...
<?php echo $__env->make('admin.layout.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projeto-base2\pmk\codigo\resources\views/admin/user/index.blade.php ENDPATH**/ ?>