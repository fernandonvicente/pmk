    ...
    <div class="box-body">
      <div class="col-md-12">
        <div class="nav-tabs-custom">
          <?php if($cliente_id > 0): ?>
            <p style="font-weight: bold; color: #ff0000;"><?php echo e($nome); ?> - <?php echo e($telefone); ?></p>
          <?php endif; ?>
              ...
              <form action="javascript:void(0);" name="formCliente" id="formCliente" method="post"> 
                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <?php echo e(Form::text('telefone', $telefone, ['id' => 'telefone','class' => 'form-control telx','placeholder' => '(XX) XXXX-XXXX', 'tabindex' => '4' ])); ?>                      
                    </div>              
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      'class' => 'form-control', 'id' => 'cliente_status_id', 'required' => 'required', 'tabindex' => '13'])); ?>
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      <label>Celular</label>
                      <?php echo e(Form::text('celular', $celular, ['id' => 'celular','class' => 'form-control celx','placeholder' => '(XX) XXXXX-XXXX', 'tabindex' => '14' ])); ?>
                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      <?php if($arquivo): ?>
                      <label class="control-label">Ver Arquivo</label>
                      <p>
                        <a href="<?php echo e(url('/controleinternoadmin/cliente/download')); ?>/<?php echo e($arquivo); ?>" target="_blank"><img src="<?php echo e(asset('storage/cliente/arquivos/'.$arquivo)); ?>" width="50" height="50"></a>
                      </p>
                      <a href="javascript:void(0);" onclick="excluirArquivo(<?php echo e($cliente_id); ?>);"><i class="fa fa-fw fa-trash" style="color: #ff0000;" title="Excluir Arquivo"></i> Excluir Arquivo </a>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        <label>* Localização</label>
                         <?php echo e(Form::text('localizacao', $localizacao, ['id' => 'localizacao','class' => 'form-control clearInput','placeholder' => 'Localização' ])); ?>
                   ...
                   <div class="row">                
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <?php echo e(Form::textarea('descricao_senha', $descricao_senha, ['id' => 'descricao_senha','class' => 'form-control clearInput','placeholder' => 'Descreva a observação.',  'rows' => 10, 'cols' => 50 ])); ?>
...
<?php echo $__env->make('admin.layout.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projeto-base2\pmk\codigo\resources\views/admin/cliente/create-edit.blade.php ENDPATH**/ ?>