          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">
                  ...
                  <a href="<?php echo e(url('/controleinternoadmin/cliente/create')); ?>"> 
   ...
   var table = $('#tb_datatable').DataTable({
    ...
    oLanguage: {
      ...
      buttons: [
       ...
       serverSide: true,
       ajax: {
           url: '<?php echo url("/controleinternoadmin/cliente/carregaTabela"); ?>',
           data: function ( d ) {
...
<?php echo $__env->make('admin.layout.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projeto-base2\pmk\codigo\resources\views/admin/cliente/indexajax.blade.php ENDPATH**/ ?>