...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.user.index', compact('title','pagAction','users')); 
    }
        ...
        try{
            ...
            if($insert){     
                ...
                if($insert && $insertRoleUser){
                    ...
                    return redirect('pmkadmin/user/index')
            ...
            DB::rollBack();
            return redirect('pmkadmin/user/create')
        ...
        try{
            ...
            if($update){    
                ...
                if($update){
                    ...
                    return redirect('pmkadmin/user/edit/'.$user->id)
            ...
            DB::rollBack();
             return redirect('pmkadmin/user/edit/role/'.$user->id)
             ->with('message', 'Erro na alteração - update! '.$e->getMessage())
             ->withInput();
        }
    ...
    public function createProfilePermission(Request $request)
    {
        ...
        try{  
            ...
            return redirect('pmkadmin/user/permission/role/'.$role_id)->with('message', 'Inclusão realizada com sucesso!');
            ...
            return redirect('pmkadmin/user/permission/role/'.$role_id)->with('message', 'Erro na inclusão! '.$e->getMessage());
          }
    }
}
