            ...
            <div class="box-header">
              <h3 class="box-title">  
                <div class="col-xs-12">  
                  ...
                  @can('create_usuarios')
                  <a href="{{ url('pmkadmin/user/create') }}">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    @can('edit_usuarios')
                    <a href="{{ url('pmkadmin/user/edit') }}/{{ $user->id }}"><i class="fa fa-fw fa-edit" title="Editar"></i></a>
                    @endcan
...
<script>
  ...
  function excluirRegistro(idRegistro){
    if (confirm("Tem certeza que deseja excluir o registro?")) {
      ...
      $.get('{{ url("/pmkadmin/user/delete/") }}/' + id, function (resposta) {
