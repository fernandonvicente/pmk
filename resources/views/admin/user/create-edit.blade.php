...
@section('content-header')
  <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{ url('pmkadmin/user/index') }}">Usuários</a></li>
        @endif
  ...
  @endif
      ...
      <div class="box box-default">
        ...
        @if($formAction=='create')
         <form action="{{ url('pmkadmin/user/store') }}" method="post" id="form_submit" name="form_submit" autocomplete="off" enctype="multipart/form-data">
        @else
          <form action="{{ url('pmkadmin/user/update') }}/{{ $id }}" method="put" id="form_submit" name="form_submit" autocomplete="off" enctype="multipart/form-data">
        @endif
...
function excluirImagem(e){
  if (confirm("Tem certeza que deseja excluir a imagem?")) {
    ...
    $.post('{{ url("assets/funcoes/uploadGerenciamento.php") }}', {
      ...
      $.get('{{ url("/pmkadmin/user/updateAvatar/") }}/' + id, function (resposta) {
        // alert(resposta);
      });
      //
    });
