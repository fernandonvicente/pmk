...
<section class="content">
  ...
  <form method="POST" action="{{ url('pmkadmin/user/createProfilePermission') }}" accept-charset="UTF-8" role="form" id="form_submit" autocomplete="off" enctype="multipart/form-data">
    {{ csrf_field() }}
